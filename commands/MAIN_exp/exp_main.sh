...
CUDA_VISIBLE_DEVICES=0 python finetune.py --per_device_train_batch_size=32\
 ...
 --train_data='/hpc2hdd/home/yyang937/datasets/gwilliams2023/preprocess8/info/split3/cable_spool_fort/lw1/train.jsonl'\
 --test_data='/hpc2hdd/home/yyang937/datasets/gwilliams2023/preprocess8/info/split3/cable_spool_fort/lw1/val.jsonl'\
 --base_model='openai/whisper-base' --augment_config_path=None\
 --local_files_only=True --language='English' --device='cuda' --additional_runname='Exp1'

# non teacher-forcing
CUDA_VISIBLE_DEVICES=0 python evaluation.py\
  --checkpoint_path='/hpc2hdd/home/yyang937/brain2text/mad/ckpt/'\
  --test_data='/hpc2hdd/home/yyang937/datasets/gwilliams2023/preprocess8/info/split3/cable_spool_fort/lw1/test.jsonl'\
...
CUDA_VISIBLE_DEVICES=0 python evaluation.py\
  --checkpoint_path='/hpc2hdd/home/yyang937/brain2text/mad/output_model/Exp1_1112_1722_mmd_bm_0.1mmd_0.1_0.0003_32_trainable_brainmodule_True_adalora_False/whisper-base/checkpoint-7000/'\
  --test_data='/hpc2hdd/home/yyang937/datasets/gwilliams2023/preprocess8/info/split3/cable_spool_fort/lw1/test.jsonl'\
  --modal='eeg' --sampling_rate=100 --eeg_ch=208 --batch_size=4 --num_workers=4 --language='English'\
  --timestamps=False --local_files_only=True --teacher_forcing=False --post_processing=True
